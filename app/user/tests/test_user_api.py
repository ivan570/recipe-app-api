...
class PublicUserApiTests(TestCase):
    ...
    def test_password_too_short_error(self):
        """Test an error is retured if password less than 5 charts"""
        payload = {
            'email': 'test@example.com',
            'password': 'pw',
            'name': 'Test name'
    ...
    def test_create_token_forur(self):
    ...
    def test_create_token_bad_credentials(self):
        ...
        create_user(email='test@example.com', password='test-password')
        payload = {
            'email': 'test@example.com',
...
class PrivateUserApiTest(TestCase):
    ...
    def test_post_me_not_allowed(self):
        """Test  POST is not allow for ME_URL"""
